...
app = FastAPI()  # Istanziamo un oggetto di classe FastAPI che si occuperò di gestire tutta la
# nostra applicazione server
...
def get_piatto_da_id(id_piatto: int):
    # FastAPI si preoccuperà di convertire il numero scritto in formato stringa nell'URL al formato
    # numero int
