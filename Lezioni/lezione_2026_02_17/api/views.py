...
from .serializers import DispositivoSerializer, LuogoSerializer, ManutenzioneSerializer, SoftwareSerializer
...
class DispositivoViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [filters.SearchFilter] # Es: per ordinare

    # 2. Definiamo i campi su cui possiamo svolgere una ricerca
    search_fields = ['codice', 'descrizione', 'luogo__nome']
